...
<body id="page-top">
    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: var(--bs-dark);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#"><i class="fas fa-server"></i>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top" style="--bs-body-bg: #ffffff;background: url(&quot;assets/img/Blue-and-purple-abstract-background_1600x900.jpg&quot;), var(--bs-indigo);filter: brightness(109%) contrast(87%);">
                    <div class="container-fluid"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#"><i class="fas fa-server" style="color: var(--bs-light);"></i>
                            <div class="sidebar-brand-icon rotate-n-15"></div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card shadow mb-3" style="width: 442.725px;">
                                ...
                                <div class="card-body" style="width: 428.725px;">
                                <form action="action.php" method="post" >
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3">
                                                <div class="mb-3"><label class="form-label" for="company"><strong>Hostname</strong><br></label><input class="form-control" type="text" id="company" placeholder="Enter hostname from alert" name="name"required value="<?php echo $name; ?>"></div><label class="form-label" for="alert-type"><strong>Alert Type</strong><br></label>
                                    ...
                                    <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit" style="color: var(--bs-body-bg);background: var(--bs-purple);">Submit</button></div>
                                </form>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card shadow mb-3" style="width: 528.875px;">
                                <div class="card-header py-3" style="height: 45px;width: 526.875px;"><label class="form-label" for="username" style="color: var(--bs-purple);line-height: 24px;"><strong>Hasil Pengecheckan Alert</strong></label></div>
